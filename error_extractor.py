...
def main():
    ...
    parser.add_argument('--properties-file', default='src/test/fuzzing/properties/Properties_ERR.sol', 
                       help='Path to Properties_ERR.sol file (default: src/test/fuzzing/properties/Properties_ERR.sol)')
